# API C UIWidgetManager.GetZoneControlVisualizationInfo
...
==Returns==
:;widgetInfo:{{apitype|ZoneControlVisualizationInfo?}}
{| class="sortable darktable zebra" style="margin-left: 3.9em"
! Field !! Type !! Description
|-
| shownState || {{apitype|Enum.WidgetShownState}} || 
|-
| mode || {{apitype|Enum.ZoneControlMode}} || 
|-
| leadingEdgeType || {{apitype|Enum.ZoneControlLeadingEdgeType}} || 
|-
| dangerFlashType || {{apitype|Enum.ZoneControlDangerFlashType}} || 
|-
| zoneEntries || {{apitype|ZoneEntry[]}} || 
|-
