...
{{i-note|This list is up to date as of &nbsp;[[File:PTR_client.png|16px|link=]] [[Patch_11.2.0/API_changes|Patch 11.2.0]] (62253) Jul 25 2025}}
=API systems=
These functions are categorized by Blizzard API system.
...
==AccountStore==
: [[API C_AccountStore.BeginPurchase|C_AccountStore.BeginPurchase]](<span class="apiarg">itemID</span>) : <span class="apiret">purchaseStarted</span>
: [[API C_AccountStore.GetCategories|C_AccountStore.GetCategories]](<span class="apiarg">storeFrontID</span>) : <span class="apiret">categories</span>
: [[API C_AccountStore.GetCategoryInfo|C_AccountStore.GetCategoryInfo]](<span class="apiarg">categoryID</span>) : <span class="apiret">info</span>
: [[API C_AccountStore.GetCategoryItems|C_AccountStore.GetCategoryItems]](<span class="apiarg">categoryID</span>) : <span class="apiret">itemIDs</span>
: [[API C_AccountStore.GetCurrencyAvailable|C_AccountStore.GetCurrencyAvailable]](<span class="apiarg">currencyID</span>) : <span class="apiret">amount</span>
: [[API C_AccountStore.GetCurrencyIDForStore|C_AccountStore.GetCurrencyIDForStore]](<span class="apiarg">storeFrontID</span>) : <span class="apiret">currencyID</span>
: [[API C_AccountStore.GetCurrencyInfo|C_AccountStore.GetCurrencyInfo]](<span class="apiarg">currencyID</span>) : <span class="apiret">info</span>
: [[API C_AccountStore.GetItemInfo|C_AccountStore.GetItemInfo]](<span class="apiarg">itemID</span>) : <span class="apiret">info</span>
: [[API C_AccountStore.GetStoreFrontState|C_AccountStore.GetStoreFrontState]](<span class="apiarg">storeFrontID</span>) : <span class="apiret">state</span>
: [[API C_AccountStore.RefundItem|C_AccountStore.RefundItem]](<span class="apiarg">itemID</span>) : <span class="apiret">refundStarted</span>
: [[API C_AccountStore.RequestStoreFrontInfoUpdate|C_AccountStore.RequestStoreFrontInfoUpdate]](<span class="apiarg">storeFrontID</span>)
...
: [[API C_AchievementTelemetry.LinkAchievementInClub|C_AchievementTelemetry.LinkAchievementInClub]](<span class="apiarg">achievementID</span>)
: [[API C_AchievementTelemetry.LinkAchievementInWhisper|C_AchievementTelemetry.LinkAchievementInWhisper]](<span class="apiarg">achievementID</span>)
: [[API C_AchievementTelemetry.ShowAchievements|C_AchievementTelemetry.ShowAchievements]]()

==ActionBar==
: [[API C_ActionBar.EnableActionRangeCheck|C_ActionBar.EnableActionRangeCheck]](<span class="apiarg">actionID, enable</span>)
: [[API C_ActionBar.FindAssistedCombatActionButtons|C_ActionBar.FindAssistedCombatActionButtons]]() : <span class="apiret">slots</span>
...
: [[API C_ActionBar.ForceUpdateAction|C_ActionBar.ForceUpdateAction]](<span class="apiarg">slotID</span>)
...
: [[API C_ActionBar.HasAssistedCombatActionButtons|C_ActionBar.HasAssistedCombatActionButtons]]() : <span class="apiret">hasButtons</span>
...
: [[API C_ActionBar.IsAssistedCombatAction|C_ActionBar.IsAssistedCombatAction]](<span class="apiarg">slotID</span>) : <span class="apiret">isAssistedCombatAction</span>
...
: [[API C_AddOns.DoesAddOnHaveLoadError|C_AddOns.DoesAddOnHaveLoadError]](<span class="apiarg">name</span>) : <span class="apiret">hadError</span>
...
: [[API C_AddOns.GetAddOnInterfaceVersion|C_AddOns.GetAddOnInterfaceVersion]](<span class="apiarg">name</span>) : <span class="apiret">interfaceVersion</span> - Returns the value of the Interface directive in an addon TOC file.
: [[API C_AddOns.GetAddOnLocalTable|C_AddOns.GetAddOnLocalTable]](<span class="apiarg">name</span>) : <span class="apiret">table</span>
...
: [[API C_AddOns.IsAddOnDefaultEnabled|C_AddOns.IsAddOnDefaultEnabled]](<span class="apiarg">name</span>) : <span class="apiret">defaultEnabled</span>
...
==AddOnProfiler==
: [[API C_AddOnProfiler.AddMeasuredCallEvent|C_AddOnProfiler.AddMeasuredCallEvent]](<span class="apiarg">name</span>)
: [[API C_AddOnProfiler.AddPerformanceMessageShown|C_AddOnProfiler.AddPerformanceMessageShown]](<span class="apiarg">msg</span>)
: [[API C_AddOnProfiler.CheckForPerformanceMessage|C_AddOnProfiler.CheckForPerformanceMessage]]() : <span class="apiret">msg</span>
: [[API C_AddOnProfiler.GetAddOnMetric|C_AddOnProfiler.GetAddOnMetric]](<span class="apiarg">name, metric</span>) : <span class="apiret">result</span>
: [[API C_AddOnProfiler.GetApplicationMetric|C_AddOnProfiler.GetApplicationMetric]](<span class="apiarg">metric</span>) : <span class="apiret">result</span>
: [[API C_AddOnProfiler.GetOverallMetric|C_AddOnProfiler.GetOverallMetric]](<span class="apiarg">metric</span>) : <span class="apiret">result</span>
: [[API C_AddOnProfiler.GetTicksPerSecond|C_AddOnProfiler.GetTicksPerSecond]]() : <span class="apiret">frequency</span>
: [[API C_AddOnProfiler.GetTopKAddOnsForMetric|C_AddOnProfiler.GetTopKAddOnsForMetric]](<span class="apiarg">metric, k</span>) : <span class="apiret">results</span>
: [[API C_AddOnProfiler.IsEnabled|C_AddOnProfiler.IsEnabled]]() : <span class="apiret">enabled</span>
: [[API C_AddOnProfiler.MeasureCall|C_AddOnProfiler.MeasureCall]](<span class="apiarg">func, unpackedPrimitiveType</span>) : <span class="apiret">results, unpackedPrimitiveType</span>
...
==AssistedCombat==
: [[API C_AssistedCombat.GetActionSpell|C_AssistedCombat.GetActionSpell]]() : <span class="apiret">spellID</span>
: [[API C_AssistedCombat.GetNextCastSpell|C_AssistedCombat.GetNextCastSpell]](<span class="apiarg">[checkForVisibleButton]</span>) : <span class="apiret">spellID</span>
: [[API C_AssistedCombat.GetRotationSpells|C_AssistedCombat.GetRotationSpells]]() : <span class="apiret">spellIDs</span>
: [[API C_AssistedCombat.IsAvailable|C_AssistedCombat.IsAvailable]]() : <span class="apiret">isAvailable, failureReason</span>
...
: [[API C_AuctionHouse.ShouldAutoPopulatePrice|C_AuctionHouse.ShouldAutoPopulatePrice]]() : <span class="apiret">shouldAutoPopulatePrice</span>
...
: [[API C_AuctionHouse.SupportsCopperValues|C_AuctionHouse.SupportsCopperValues]]() : <span class="apiret">supportsCopperValues</span>
...
==Bank==
: [[API C_Bank.AreAnyBankTypesViewable|C_Bank.AreAnyBankTypesViewable]]() : <span class="apiret">areAnyBankTypesViewable</span>
...
: [[API C_Bank.DoesBankTypeSupportAutoDeposit|C_Bank.DoesBankTypeSupportAutoDeposit]](<span class="apiarg">bankType</span>) : <span class="apiret">doesBankTypeSupportAutoDeposit</span>
: [[API C_Bank.DoesBankTypeSupportMoneyTransfer|C_Bank.DoesBankTypeSupportMoneyTransfer]](<span class="apiarg">bankType</span>) : <span class="apiret">doesBankTypeSupportMoneyTransfer</span>
: [[API C_Bank.FetchBankLockedReason|C_Bank.FetchBankLockedReason]](<span class="apiarg">bankType</span>) : <span class="apiret">reason</span>
: [[API C_Bank.FetchDepositedMoney|C_Bank.FetchDepositedMoney]](<span class="apiarg">bankType</span>) : <span class="apiret">amount</span>
: [[API C_Bank.FetchNextPurchasableBankTabData|C_Bank.FetchNextPurchasableBankTabData]](<span class="apiarg">bankType</span>) : <span class="apiret">nextPurchasableTabData</span>
...
: [[API C_Bank.FetchViewableBankTypes|C_Bank.FetchViewableBankTypes]]() : <span class="apiret">viewableBankTypes</span>
...
: [[API C_BarberShop.HasAlteredForm|C_BarberShop.HasAlteredForm]]() : <span class="apiret">hasAlteredForm</span>
: [[API C_BarberShop.HasAnyChanges|C_BarberShop.HasAnyChanges]]() : <span class="apiret">hasChanges</span>
: [[API C_BarberShop.HasCustomizationFeature|C_BarberShop.HasCustomizationFeature]](<span class="apiarg">featureMask</span>) : <span class="apiret">hasCustomizationFeature</span>
...
: [[API C_BarberShop.SetViewingChrModel|C_BarberShop.SetViewingChrModel]](<span class="apiarg">[chrModelID [, spellShapeshiftFormID]]</span>)
...
: [[API IsPublicTestClient|IsPublicTestClient]]() : <span class="apiret">isPublicTestClient</span>
...
: [[API C_ChallengeMode.GetChallengeCompletionInfo|C_ChallengeMode.GetChallengeCompletionInfo]]() : <span class="apiret">info</span>
...
: [[API C_ChallengeMode.GetLeaverPenaltyWarningTimeLeft|C_ChallengeMode.GetLeaverPenaltyWarningTimeLeft]]() : <span class="apiret">timeLeftSeconds</span>
...
: [[API C_ChallengeMode.GetMapUIInfo|C_ChallengeMode.GetMapUIInfo]](<span class="apiarg">mapChallengeModeID</span>) : <span class="apiret">name, id, timeLimit, texture, backgroundTexture, mapID</span>
...
: [[API C_ChallengeMode.GetStartTime|C_ChallengeMode.GetStartTime]]() : <span class="apiret">startTime</span>
...
: [[API C_ChallengeMode.IsChallengeModeResettable|C_ChallengeMode.IsChallengeModeResettable]]() : <span class="apiret">canReset</span>
...
: [[API C_ChatInfo.DropCautionaryChatMessage|C_ChatInfo.DropCautionaryChatMessage]](<span class="apiarg">confirmNumber</span>)
...
: [[API C_ChatInfo.IsLoggingChat|C_ChatInfo.IsLoggingChat]]() : <span class="apiret">enabled</span>
: [[API C_ChatInfo.IsLoggingCombat|C_ChatInfo.IsLoggingCombat]]() : <span class="apiret">enabled, advanced</span>
...
: [[API C_ChatInfo.SendCautionaryChatMessage|C_ChatInfo.SendCautionaryChatMessage]](<span class="apiarg">confirmNumber</span>)
: [[API C_ChatInfo.SendChatMessage|C_ChatInfo.SendChatMessage]](<span class="apiarg">message [, chatType [, languageID [, target]]]</span>) - Sends a chat message.
...
==Client==
: [[API FlashClientIcon|FlashClientIcon]](<span class="apiarg">[briefly]</span>) - Flashes the game client icon in the Operating System.
...
: [[API IsCpuBound|IsCpuBound]]() : <span class="apiret">isCpuBound</span>
...
: [[API C_Club.AreMembersReady|C_Club.AreMembersReady]](<span class="apiarg">clubId</span>) : <span class="apiret">membersReady</span>
...
: [[API C_Club.FocusMembers|C_Club.FocusMembers]](<span class="apiarg">clubId</span>)
...
: [[API C_Club.UnfocusMembers|C_Club.UnfocusMembers]](<span class="apiarg">clubId</span>)
...
==ColorOverrides==
: [[API C_ColorOverrides.ClearColorOverrides|C_ColorOverrides.ClearColorOverrides]]()
: [[API C_ColorOverrides.GetColorForQuality|C_ColorOverrides.GetColorForQuality]](<span class="apiarg">quality</span>) : <span class="apiret">color</span>
: [[API C_ColorOverrides.GetColorOverrideInfo|C_ColorOverrides.GetColorOverrideInfo]](<span class="apiarg">overrideType</span>) : <span class="apiret">overrideInfo</span>
: [[API C_ColorOverrides.GetDefaultColorForQuality|C_ColorOverrides.GetDefaultColorForQuality]](<span class="apiarg">quality</span>) : <span class="apiret">color</span>
: [[API C_ColorOverrides.RemoveColorOverride|C_ColorOverrides.RemoveColorOverride]](<span class="apiarg">overrideType</span>)
: [[API C_ColorOverrides.SetColorOverride|C_ColorOverrides.SetColorOverride]](<span class="apiarg">overrideType, color</span>)
...
: [[API C_Commentator.SpellUsesItemCharges|C_Commentator.SpellUsesItemCharges]](<span class="apiarg">spellID</span>) : <span class="apiret">spellUsesItemCharges</span>
...
: [[API GetNativeRealmID|GetNativeRealmID]]() : <span class="apiret">nativeRealmID</span>
...
: [[API ConsoleEcho|ConsoleEcho]](<span class="apiarg">command [, addToHistory [, prefix]]</span>) : <span class="apiret">result</span>
...
: [[API C_Container.HasContainerItem|C_Container.HasContainerItem]](<span class="apiarg">containerIndex, slotIndex</span>) : <span class="apiret">hasItem</span>
...
: [[API C_Container.SortBank|C_Container.SortBank]](<span class="apiarg">bankType</span>)
...
Relates to buildings on the [[Broken Shore]] or [[Warfront|Warfronts]]
...
==CooldownViewer==
: [[API C_CooldownViewer.GetCooldownViewerCategorySet|C_CooldownViewer.GetCooldownViewerCategorySet]](<span class="apiarg">category</span>) : <span class="apiret">cooldownIDs</span>
: [[API C_CooldownViewer.GetCooldownViewerCooldownInfo|C_CooldownViewer.GetCooldownViewerCooldownInfo]](<span class="apiarg">cooldownID</span>) : <span class="apiret">cooldownInfo</span>
: [[API C_CooldownViewer.IsCooldownViewerAvailable|C_CooldownViewer.IsCooldownViewerAvailable]]() : <span class="apiret">isAvailable, failureReason</span>
...
: [[API C_CreatureInfo.GetCreatureFamilyIDs|C_CreatureInfo.GetCreatureFamilyIDs]]() : <span class="apiret">creatureFamilyIDs</span>
: [[API C_CreatureInfo.GetCreatureFamilyInfo|C_CreatureInfo.GetCreatureFamilyInfo]](<span class="apiarg">creatureFamilyID</span>) : <span class="apiret">creatureFamilyInfo</span>
: [[API C_CreatureInfo.GetCreatureTypeIDs|C_CreatureInfo.GetCreatureTypeIDs]]() : <span class="apiret">creatureTypeIDs</span>
: [[API C_CreatureInfo.GetCreatureTypeInfo|C_CreatureInfo.GetCreatureTypeInfo]](<span class="apiarg">creatureTypeID</span>) : <span class="apiret">creatureTypeInfo</span>
...
: [[API C_CurrencyInfo.DoesCurrentFilterRequireAccountCurrencyData|C_CurrencyInfo.DoesCurrentFilterRequireAccountCurrencyData]]() : <span class="apiret">doesCurrentFilterRequireAccountCurrencyData</span>
...
: [[API C_CurrencyInfo.GetCurrencyFilter|C_CurrencyInfo.GetCurrencyFilter]]() : <span class="apiret">filterType</span>
...
: [[API C_CurrencyInfo.IsCurrencyTransferInProgress|C_CurrencyInfo.IsCurrencyTransferInProgress]]() : <span class="apiret">currencyTransferInProgress</span>
...
: [[API C_CurrencyInfo.SetCurrencyBackpackByID|C_CurrencyInfo.SetCurrencyBackpackByID]](<span class="apiarg">currencyType, backpack</span>)
: [[API C_CurrencyInfo.SetCurrencyFilter|C_CurrencyInfo.SetCurrencyFilter]](<span class="apiarg">filterType</span>)
...
==DelvesUI==
: [[API C_DelvesUI.GetCompanionInfoForActivePlayer|C_DelvesUI.GetCompanionInfoForActivePlayer]]() : <span class="apiret">playerCompanionInfoID</span>
...
: [[API C_DelvesUI.GetCurioLink|C_DelvesUI.GetCurioLink]](<span class="apiarg">spellID, rarity</span>) : <span class="apiret">curioLink</span>
: [[API C_DelvesUI.GetCurioNodeForCompanion|C_DelvesUI.GetCurioNodeForCompanion]](<span class="apiarg">curioType [, companionID]</span>) : <span class="apiret">nodeID</span>
...
: [[API C_DelvesUI.GetRoleSubtreeForCompanion|C_DelvesUI.GetRoleSubtreeForCompanion]](<span class="apiarg">roleType [, companionID]</span>) : <span class="apiret">subTreeID</span>
...
==EncodingUtil==
: [[API C_EncodingUtil.CompressString|C_EncodingUtil.CompressString]](<span class="apiarg">source [, method [, level]]</span>) : <span class="apiret">output</span> - Compresses a supplied string.
: [[API C_EncodingUtil.DecodeBase64|C_EncodingUtil.DecodeBase64]](<span class="apiarg">source [, variant]</span>) : <span class="apiret">output</span> - Decodes a Base64 encoded string.
: [[API C_EncodingUtil.DecodeHex|C_EncodingUtil.DecodeHex]](<span class="apiarg">source</span>) : <span class="apiret">output</span> - Decodes a Base16 (hexadecimal) encoded string.
: [[API C_EncodingUtil.DecompressString|C_EncodingUtil.DecompressString]](<span class="apiarg">source [, method]</span>) : <span class="apiret">output</span> - Decompresses a compressed string.
: [[API C_EncodingUtil.DeserializeCBOR|C_EncodingUtil.DeserializeCBOR]](<span class="apiarg">source</span>) : <span class="apiret">value</span> - Deserializes a CBOR data string to a Lua value.
: [[API C_EncodingUtil.DeserializeJSON|C_EncodingUtil.DeserializeJSON]](<span class="apiarg">source</span>) : <span class="apiret">value</span> - Deserializes a JSON data string to a Lua value.
: [[API C_EncodingUtil.EncodeBase64|C_EncodingUtil.EncodeBase64]](<span class="apiarg">source [, variant]</span>) : <span class="apiret">output</span> - Converts a string to a Base64 encoded representation.
: [[API C_EncodingUtil.EncodeHex|C_EncodingUtil.EncodeHex]](<span class="apiarg">source</span>) : <span class="apiret">output</span> - Converts a string to a Base16 (hexadecimal) encoded representation.
: [[API C_EncodingUtil.SerializeCBOR|C_EncodingUtil.SerializeCBOR]](<span class="apiarg">[value [, options]]</span>) : <span class="apiret">output</span> - Serializes a Lua value to a CBOR data string.
: [[API C_EncodingUtil.SerializeJSON|C_EncodingUtil.SerializeJSON]](<span class="apiarg">[value [, options]]</span>) : <span class="apiret">output</span> - Serializes a Lua value to a JSON data string.
...
==EndOfMatchUI==
: [[API C_EndOfMatchUI.GetEndOfMatchDetails|C_EndOfMatchUI.GetEndOfMatchDetails]]() : <span class="apiret">matchDetails</span>
...
==EventSchedulerUI==
: [[API C_EventScheduler.ClearReminder|C_EventScheduler.ClearReminder]](<span class="apiarg">eventKey</span>)
: [[API C_EventScheduler.GetActiveContinentName|C_EventScheduler.GetActiveContinentName]]() : <span class="apiret">name</span>
: [[API C_EventScheduler.GetEventUiMapID|C_EventScheduler.GetEventUiMapID]](<span class="apiarg">areaPoiID</span>) : <span class="apiret">uiMapID</span>
: [[API C_EventScheduler.GetEventZoneName|C_EventScheduler.GetEventZoneName]](<span class="apiarg">areaPoiID</span>) : <span class="apiret">name</span>
: [[API C_EventScheduler.GetOngoingEvents|C_EventScheduler.GetOngoingEvents]]() : <span class="apiret">events</span>
: [[API C_EventScheduler.GetScheduledEvents|C_EventScheduler.GetScheduledEvents]]() : <span class="apiret">events</span>
: [[API C_EventScheduler.HasData|C_EventScheduler.HasData]]() : <span class="apiret">hasData</span>
: [[API C_EventScheduler.HasSavedReminders|C_EventScheduler.HasSavedReminders]]() : <span class="apiret">hasSavedReminders</span>
: [[API C_EventScheduler.RequestEvents|C_EventScheduler.RequestEvents]]()
: [[API C_EventScheduler.SetReminder|C_EventScheduler.SetReminder]](<span class="apiarg">eventKey</span>)
...
: [[API ClassicExpansionAtMost|ClassicExpansionAtMost]](<span class="apiarg">expansionLevel</span>) : <span class="apiret">isAtMost</span>
...
==Font==
: [[API CreateFontFamily|CreateFontFamily]](<span class="apiarg">name, members</span>) : <span class="apiret">fontFamily</span>
...
==FrameScript==
: [[API CreateFromMixins|CreateFromMixins]](<span class="apiarg">unpackedPrimitiveType</span>) : <span class="apiret">object</span>
: [[API CreateWindow|CreateWindow]](<span class="apiarg">[popupStyle [, topMost]]</span>) : <span class="apiret">window</span>
: [[API debugprofilestart|debugprofilestart]]() - Starts a timer for profiling. The final time can be obtained by calling debugprofilestop.
: [[API debugprofilestop|debugprofilestop]]() : <span class="apiret">elapsedMilliseconds</span> - Returns the time in milliseconds since the last debugprofilestart call.
...
: [[API GetSourceLocation|GetSourceLocation]]() : <span class="apiret">location</span>
: [[API Mixin|Mixin]](<span class="apiarg">object, unpackedPrimitiveType</span>) : <span class="apiret">outObject</span>
...
==GameRules==
: [[API C_GameRules.AutoConnectToGameModeRealm|C_GameRules.AutoConnectToGameModeRealm]](<span class="apiarg">gameModeRecordID</span>)
: [[API C_GameRules.DoesGameModeHavePromo|C_GameRules.DoesGameModeHavePromo]](<span class="apiarg">gameModeRecordID</span>) : <span class="apiret">hasPromo</span>
: [[API C_GameRules.GetActiveGameMode|C_GameRules.GetActiveGameMode]]() : <span class="apiret">gameMode</span>
: [[API C_GameRules.GetCurrentEventRealmQueues|C_GameRules.GetCurrentEventRealmQueues]]() : <span class="apiret">eventRealmQueues</span>
: [[API C_GameRules.GetCurrentGameModeDisplayInfo|C_GameRules.GetCurrentGameModeDisplayInfo]]() : <span class="apiret">info</span>
: [[API C_GameRules.GetCurrentGameModeRecordID|C_GameRules.GetCurrentGameModeRecordID]]() : <span class="apiret">gameModeRecordID</span>
: [[API C_GameRules.GetDisplayedGameModeRecordIDAtIndex|C_GameRules.GetDisplayedGameModeRecordIDAtIndex]](<span class="apiarg">displayIndex</span>) : <span class="apiret">gameModeRecordID</span>
: [[API C_GameRules.GetGameModeDisplayInfoByRecordID|C_GameRules.GetGameModeDisplayInfoByRecordID]](<span class="apiarg">gameModeRecordID</span>) : <span class="apiret">info</span>
: [[API C_GameRules.GetGameModeGlueScreenName|C_GameRules.GetGameModeGlueScreenName]]() : <span class="apiret">screenName</span>
: [[API C_GameRules.GetGameModePromoGlobalString|C_GameRules.GetGameModePromoGlobalString]](<span class="apiarg">gameModeRecordID</span>) : <span class="apiret">promoGlobalString</span>
...
: [[API C_GameRules.GetGameRuleAsFrameStrata|C_GameRules.GetGameRuleAsFrameStrata]](<span class="apiarg">gameRule</span>) : <span class="apiret">frameStrata</span>
: [[API C_GameRules.GetNumDisplayedGameModes|C_GameRules.GetNumDisplayedGameModes]]() : <span class="apiret">numDisplayedGameModes</span>
: [[API C_GameRules.IsCharacterlessLoginActive|C_GameRules.IsCharacterlessLoginActive]]() : <span class="apiret">active</span>
...
: [[API C_Garrison.IsLandingPageMinimapButtonVisible|C_Garrison.IsLandingPageMinimapButtonVisible]](<span class="apiarg">garrType</span>) : <span class="apiret">isLandingPageMinimapButtonVisible</span>
...
==Glue==
: [[API C_Glue.IsFirstLoadThisSession|C_Glue.IsFirstLoadThisSession]]() : <span class="apiret">IsFirstLoadThisSession</span>
: [[API C_Glue.IsOnGlueScreen|C_Glue.IsOnGlueScreen]]() : <span class="apiret">isOnGlueScreen</span>
...
: [[API C_GuildInfo.RequestGuildRename|C_GuildInfo.RequestGuildRename]](<span class="apiarg">desiredName</span>)
: [[API C_GuildInfo.RequestGuildRenameRefund|C_GuildInfo.RequestGuildRenameRefund]]()
: [[API C_GuildInfo.RequestRenameNameCheck|C_GuildInfo.RequestRenameNameCheck]](<span class="apiarg">desiredName</span>)
: [[API C_GuildInfo.RequestRenameStatus|C_GuildInfo.RequestRenameStatus]]() : <span class="apiret">ableToRequest</span>
...
==InstanceLeaverInfo==
: [[API C_InstanceLeaver.IsPlayerLeaver|C_InstanceLeaver.IsPlayerLeaver]]() : <span class="apiret">isLeaver</span>
...
: [[API C_Item.GetDelvePreviewItemQuality|C_Item.GetDelvePreviewItemQuality]](<span class="apiarg">itemID, context</span>) : <span class="apiret">itemQuality</span>
...
: [[API C_Item.GetItemUpgradeInfo|C_Item.GetItemUpgradeInfo]](<span class="apiarg">itemInfo</span>) : <span class="apiret">itemUpgradeInfo</span>
...
==LFGInfo==
: [[API C_LFGInfo.AreCrossFactionGroupQueuesAllowed|C_LFGInfo.AreCrossFactionGroupQueuesAllowed]](<span class="apiarg">lfgDungeonID</span>) : <span class="apiret">areCrossFactionGroupQueuesAllowed</span>
...
: [[API C_LFGInfo.DoesActivePartyMeetPremadeLaunchCount|C_LFGInfo.DoesActivePartyMeetPremadeLaunchCount]](<span class="apiarg">lfgDungeonID</span>) : <span class="apiret">doesActivePartyMeetPremadeLaunchCount</span>
: [[API C_LFGInfo.DoesCrossFactionQueueRequireFullPremade|C_LFGInfo.DoesCrossFactionQueueRequireFullPremade]](<span class="apiarg">lfgDungeonID</span>) : <span class="apiret">doesCrossFactionQueueRequireFullPremade</span>
...
: [[API C_LFGInfo.GetLevelUpInstances|C_LFGInfo.GetLevelUpInstances]](<span class="apiarg">currPlayerLevel, isRaid</span>) : <span class="apiret">instances</span>
...
: [[API C_LFGList.CreateListing|C_LFGList.CreateListing]](<span class="apiarg">createData</span>) : <span class="apiret">success</span> {{apitag|hwevent}} - Creates a group finder listing.
...
: [[API C_LFGList.GetAvailableActivityGroups|C_LFGList.GetAvailableActivityGroups]](<span class="apiarg">categoryID [, filter]</span>) : <span class="apiret">activityIDs</span> - Returns a list of available LFG groups.
...
: [[API C_LFGList.GetGroupLeaverCountsByRole|C_LFGList.GetGroupLeaverCountsByRole]]() : <span class="apiret">tankLeavers, healerLeavers, damageLeavers</span>
...
: [[API C_LFGList.GetPremadeGroupFinderStyle|C_LFGList.GetPremadeGroupFinderStyle]]() : <span class="apiret">style</span>
...
: [[API C_LFGList.GetSearchResultFriends|C_LFGList.GetSearchResultFriends]](<span class="apiarg">searchResultID</span>) : <span class="apiret">bnetFriends, charFriends, guildMates</span>
...
: [[API C_LFGList.GetSearchResultLeaderInfo|C_LFGList.GetSearchResultLeaderInfo]](<span class="apiarg">searchResultID</span>) : <span class="apiret">leaderInfo</span>
: [[API C_LFGList.GetSearchResultMemberCounts|C_LFGList.GetSearchResultMemberCounts]](<span class="apiarg">searchResultID</span>)
: [[API C_LFGList.GetSearchResultPlayerInfo|C_LFGList.GetSearchResultPlayerInfo]](<span class="apiarg">searchResultID, memberIndex</span>) : <span class="apiret">playerInfo</span>
...
: [[API C_LFGList.IsPlayerAuthenticatedForLFG|C_LFGList.IsPlayerAuthenticatedForLFG]](<span class="apiarg">[activityCategoryID]</span>) : <span class="apiret">isAuthenticated</span>
: [[API C_LFGList.IsPremadeGroupFinderEnabled|C_LFGList.IsPremadeGroupFinderEnabled]]() : <span class="apiret">enabled</span>
...
: [[API C_LFGList.Search|C_LFGList.Search]](<span class="apiarg">categoryID [, filter [, preferredFilters [, languageFilter [, searchCrossFactionListings [, advancedFilter [, activityIDsFilter]]]]]]</span>)
...
: [[API C_LFGList.UpdateListing|C_LFGList.UpdateListing]](<span class="apiarg">createData</span>) : <span class="apiret">success</span>
...
==LobbyMatchmakerInfo==
: [[API C_LobbyMatchmakerInfo.AbandonQueue|C_LobbyMatchmakerInfo.AbandonQueue]]()
: [[API C_LobbyMatchmakerInfo.EnterQueue|C_LobbyMatchmakerInfo.EnterQueue]](<span class="apiarg">playlistEntry</span>)
: [[API C_LobbyMatchmakerInfo.GetCurrQueuePlaylistEntry|C_LobbyMatchmakerInfo.GetCurrQueuePlaylistEntry]]() : <span class="apiret">playlistEntry</span>
: [[API C_LobbyMatchmakerInfo.GetCurrQueueState|C_LobbyMatchmakerInfo.GetCurrQueueState]]() : <span class="apiret">queueState</span>
: [[API C_LobbyMatchmakerInfo.GetQueueFromMainlineEnabled|C_LobbyMatchmakerInfo.GetQueueFromMainlineEnabled]]() : <span class="apiret">queueFromMainlineEnabled</span>
: [[API C_LobbyMatchmakerInfo.GetQueueStartTime|C_LobbyMatchmakerInfo.GetQueueStartTime]]() : <span class="apiret">queueStartTime</span>
: [[API C_LobbyMatchmakerInfo.IsInQueue|C_LobbyMatchmakerInfo.IsInQueue]]() : <span class="apiret">isInQueue</span>
: [[API C_LobbyMatchmakerInfo.RespondToQueuePop|C_LobbyMatchmakerInfo.RespondToQueuePop]](<span class="apiarg">acceptQueue</span>)
...
==Log==
: [[API C_Log.LogErrorMessage|C_Log.LogErrorMessage]](<span class="apiarg">message</span>)
: [[API C_Log.LogMessage|C_Log.LogMessage]](<span class="apiarg">message</span>)
: [[API C_Log.LogMessageWithPriority|C_Log.LogMessageWithPriority]](<span class="apiarg">priority, message</span>)
: [[API C_Log.LogWarningMessage|C_Log.LogWarningMessage]](<span class="apiarg">message</span>)
...
: [[API C_MajorFactions.IsMajorFactionHiddenFromExpansionPage|C_MajorFactions.IsMajorFactionHiddenFromExpansionPage]](<span class="apiarg">majorFactionID</span>) : <span class="apiret">isHidden</span>
...
: [[API C_Map.MapHasArt|C_Map.MapHasArt]](<span class="apiarg">uiMapID</span>) : <span class="apiret">hasArt</span> - Returns true if the map has art and can be displayed.
: [[API C_Map.OpenWorldMap|C_Map.OpenWorldMap]](<span class="apiarg">[uiMapID]</span>) {{apitag|nocombat}} - Opens the world map frame to a specified map ID.
...
: [[API C_MerchantFrame.GetItemInfo|C_MerchantFrame.GetItemInfo]](<span class="apiarg">index</span>) : <span class="apiret">info</span>
...
: [[API C_Minimap.ClearMinimapInsetInfo|C_Minimap.ClearMinimapInsetInfo]]()
...
: [[API C_Minimap.IsInsideQuestBlob|C_Minimap.IsInsideQuestBlob]](<span class="apiarg">questID</span>) : <span class="apiret">isInside</span>
...
: [[API C_Minimap.SetMinimapInsetInfo|C_Minimap.SetMinimapInsetInfo]](<span class="apiarg">minAngle, maxAngle, scalar</span>)
...
: [[API C_PaperDollInfo.GetInspectRatedBGData|C_PaperDollInfo.GetInspectRatedBGData]]() : <span class="apiret">ratedBGData</span>
...
: [[API C_PaperDollInfo.IsInventorySlotEnabled|C_PaperDollInfo.IsInventorySlotEnabled]](<span class="apiarg">slotName</span>) : <span class="apiret">isEnabled</span>
...
: [[API C_PartyInfo.CanStartInstanceAbandonVote|C_PartyInfo.CanStartInstanceAbandonVote]]() : <span class="apiret">canStart</span>
: [[API C_PartyInfo.ChallengeModeRestrictionsActive|C_PartyInfo.ChallengeModeRestrictionsActive]]() : <span class="apiret">restrictionsActive</span>
...
: [[API C_PartyInfo.GetAvailableLootMethods|C_PartyInfo.GetAvailableLootMethods]]() : <span class="apiret">methods</span>
: [[API C_PartyInfo.GetInstanceAbandonShutdownTime|C_PartyInfo.GetInstanceAbandonShutdownTime]]() : <span class="apiret">durationSeconds, timeLeftSeconds</span>
: [[API C_PartyInfo.GetInstanceAbandonVoteRequirements|C_PartyInfo.GetInstanceAbandonVoteRequirements]]() : <span class="apiret">votesRequired, keystoneOwnerVoteWeight</span>
: [[API C_PartyInfo.GetInstanceAbandonVoteResponse|C_PartyInfo.GetInstanceAbandonVoteResponse]]() : <span class="apiret">response</span>
: [[API C_PartyInfo.GetInstanceAbandonVoteTime|C_PartyInfo.GetInstanceAbandonVoteTime]]() : <span class="apiret">durationSeconds, timeLeftSeconds</span>
...
: [[API C_PartyInfo.GetLootMethod|C_PartyInfo.GetLootMethod]]() : <span class="apiret">method, masterLootPartyID, masterLooterRaidID</span> - Returns the current loot method.
...
: [[API C_PartyInfo.GetNumInstanceAbandonGroupVoteResponses|C_PartyInfo.GetNumInstanceAbandonGroupVoteResponses]]() : <span class="apiret">count</span>
...
: [[API C_PartyInfo.IsChallengeModeActive|C_PartyInfo.IsChallengeModeActive]]() : <span class="apiret">active</span>
: [[API C_PartyInfo.IsChallengeModeKeystoneOwner|C_PartyInfo.IsChallengeModeKeystoneOwner]]() : <span class="apiret">isKeystoneOwner</span>
...
: [[API C_PartyInfo.IsDelveInProgress|C_PartyInfo.IsDelveInProgress]]() : <span class="apiret">isDelveComplete</span>
...
: [[API C_PartyInfo.SetInstanceAbandonVoteResponse|C_PartyInfo.SetInstanceAbandonVoteResponse]](<span class="apiarg">response</span>)
: [[API C_PartyInfo.SetLootMethod|C_PartyInfo.SetLootMethod]](<span class="apiarg">method [, lootMaster]</span>) : <span class="apiret">success</span> - Set the current loot method.
: [[API C_PartyInfo.SetRestrictPings|C_PartyInfo.SetRestrictPings]](<span class="apiarg">restrictTo</span>)
: [[API C_PartyInfo.StartInstanceAbandonVote|C_PartyInfo.StartInstanceAbandonVote]]()
...
: [[API C_PerksProgram.RequestCartCheckout|C_PerksProgram.RequestCartCheckout]](<span class="apiarg">perksVendorItemIDs</span>)
...
==PetBattles==
The [[Pet Battle System]] was added in [[Patch 5.0.4]]
...
==PetJournalInfo==
The [[Pet Journal]] was added in [[Patch 5.0.4]].
...
: [[API C_PetJournal.DismissSummonedPet|C_PetJournal.DismissSummonedPet]](<span class="apiarg">petID</span>)
...
: [[API C_PetJournal.GetOwnedPetIDs|C_PetJournal.GetOwnedPetIDs]]() : <span class="apiret">ownedPetIDs</span>
...
: [[API C_PetJournal.GetSearchFilter|C_PetJournal.GetSearchFilter]]() : <span class="apiret">filterText</span>
...
: [[API C_PetJournal.IsCurrentlySummoned|C_PetJournal.IsCurrentlySummoned]](<span class="apiarg">petID</span>) : <span class="apiret">isSummoned</span>
...
: [[API C_PetJournal.SetSearchFilter|C_PetJournal.SetSearchFilter]](<span class="apiarg">filterText</span>) - Sets the search filter in the pet journal.
...
: [[API C_PlayerInfo.CanPlayerUseEventScheduler|C_PlayerInfo.CanPlayerUseEventScheduler]]() : <span class="apiret">canUseEventScheduler</span>
...
: [[API C_PlayerInfo.IsAccountBankEnabled|C_PlayerInfo.IsAccountBankEnabled]]() : <span class="apiret">isAccountBankEnabled</span>
: [[API C_PlayerInfo.IsCharacterBankEnabled|C_PlayerInfo.IsCharacterBankEnabled]]() : <span class="apiret">isCharacterBankEnabled</span>
...
: [[API GetExpertisePercent|GetExpertisePercent]]() : <span class="apiret">mainhandExpertisePercent, offhandExpertisePercent, rangedExpertisePercent</span>
...
: [[API GetNormalizedRealmName|GetNormalizedRealmName]]() : <span class="apiret">result</span> - Returns the name of the server, but omitting spaces, hyphens, and periods.
...
: [[API IsDrivableArea|IsDrivableArea]]() : <span class="apiret">result</span>
...
: [[API PlayerEffectiveAttackPower|PlayerEffectiveAttackPower]]() : <span class="apiret">mainHandAttackPower, offHandAttackPower, rangedAttackPower, baseAttackPower, baseRangedAttackPower</span>
...
: [[API PlayerIsInCombat|PlayerIsInCombat]]() : <span class="apiret">playerIsInCombat</span>
...
: [[API C_TaskQuest.GetQuestsOnMap|C_TaskQuest.GetQuestsOnMap]](<span class="apiarg">uiMapID</span>) : <span class="apiret">taskPOIs</span>
...
: [[API C_RaidLocks.GetRedirectedDifficultyID|C_RaidLocks.GetRedirectedDifficultyID]](<span class="apiarg">mapID, difficultyID</span>) : <span class="apiret">redirectedDifficultyID</span>
...
==SharedTraits==
: [[API C_Traits.CanEditConfig|C_Traits.CanEditConfig]](<span class="apiarg">configID</span>) : <span class="apiret">canEdit, errorMessage</span>
...
: [[API C_SocialRestrictions.CanReceiveChat|C_SocialRestrictions.CanReceiveChat]]() : <span class="apiret">canReceiveChat</span>
: [[API C_SocialRestrictions.CanSendChat|C_SocialRestrictions.CanSendChat]]() : <span class="apiret">canSendChat</span>
...
: [[API C_SpecializationInfo.GetActiveSpecGroup|C_SpecializationInfo.GetActiveSpecGroup]](<span class="apiarg">[isInspect [, isPet]]</span>) : <span class="apiret">groupIndex</span> - Returns the index of the current active specialization/talent/glyph group.
...
: [[API C_SpecializationInfo.GetNumSpecializationsForClassID|C_SpecializationInfo.GetNumSpecializationsForClassID]](<span class="apiarg">classID</span>) : <span class="apiret">specCount</span>
...
: [[API C_SpecializationInfo.GetSpecialization|C_SpecializationInfo.GetSpecialization]](<span class="apiarg">[isInspect [, isPet [, specGroupIndex]]]</span>) : <span class="apiret">specializationIndex</span> - Returns the index of the player's current specialization.
: [[API C_SpecializationInfo.GetSpecializationInfo|C_SpecializationInfo.GetSpecializationInfo]](<span class="apiarg">specializationIndex [, isInspect [, isPet [, inspectTarget [, sex [, groupIndex]]]]]</span>) : <span class="apiret">specId, name, description, icon, role, primaryStat, pointsSpent, background, previewPointsSpent, isUnlocked</span> - Returns info for a specialization.
: [[API C_SpecializationInfo.GetSpecializationMasterySpells|C_SpecializationInfo.GetSpecializationMasterySpells]](<span class="apiarg">specializationIndex [, isInspect [, isPet]]</span>) : <span class="apiret">spellIDs</span> - Returns the mastery spell ID of the specified specialization.
...
: [[API C_SpecializationInfo.GetTalentInfo|C_SpecializationInfo.GetTalentInfo]](<span class="apiarg">query</span>) : <span class="apiret">result</span> - Returns info for the specified talent.
...
: [[API C_SpecializationInfo.SetPetSpecialization|C_SpecializationInfo.SetPetSpecialization]](<span class="apiarg">specIndex [, petNumber]</span>)
...
: [[API C_SpecializationInfo.SetSpecialization|C_SpecializationInfo.SetSpecialization]](<span class="apiarg">specIndex</span>) : <span class="apiret">success</span>
...
: [[API HasLootSpecializations|HasLootSpecializations]]() : <span class="apiret">hasLootSpecializations</span>

==Spell==
: [[API C_Spell.CancelSpellByID|C_Spell.CancelSpellByID]](<span class="apiarg">spellID</span>)
...
: [[API C_Spell.EnableSpellRangeCheck|C_Spell.EnableSpellRangeCheck]](<span class="apiarg">spellIdentifier, enable</span>)
: [[API C_Spell.GetBaseSpell|C_Spell.GetBaseSpell]](<span class="apiarg">spellIdentifier [, spec]</span>) : <span class="apiret">baseSpellID</span>
...
: [[API C_SpellActivationOverlay.IsSpellOverlayed|C_SpellActivationOverlay.IsSpellOverlayed]](<span class="apiarg">spellID</span>) : <span class="apiret">isSpellOverlayed</span> - Returns true if the specified spell currently has a proc / spell activation alert (glowing border).
...
: [[API C_SpellBook.IsSpellInSpellBook|C_SpellBook.IsSpellInSpellBook]](<span class="apiarg">spellID [, spellBank [, includeOverrides]]</span>) : <span class="apiret">isInSpellBook</span>
: [[API C_SpellBook.IsSpellKnown|C_SpellBook.IsSpellKnown]](<span class="apiarg">spellID [, spellBank]</span>) : <span class="apiret">isKnown</span> - Returns whether the player (or pet) knows the given spell.
: [[API C_SpellBook.IsSpellKnownOrInSpellBook|C_SpellBook.IsSpellKnownOrInSpellBook]](<span class="apiarg">spellID [, spellBank [, includeOverrides]]</span>) : <span class="apiret">isKnownOrInSpellBook</span>
...
: [[API C_SplashScreen.SendSplashScreenActionLaunchedTelem|C_SplashScreen.SendSplashScreenActionLaunchedTelem]]()
: [[API C_SplashScreen.SendSplashScreenCloseTelem|C_SplashScreen.SendSplashScreenCloseTelem]]()
...
: [[API C_StableInfo.GetAvailablePetSpecInfos|C_StableInfo.GetAvailablePetSpecInfos]]() : <span class="apiret">petSpecInfos</span>
...
: [[API C_StorePublic.EventStoreUISetShown|C_StorePublic.EventStoreUISetShown]](<span class="apiarg">newShown [, contextKey]</span>)
...
: [[API C_SuperTrack.GetNextWaypointForMap|C_SuperTrack.GetNextWaypointForMap]](<span class="apiarg">uiMapID</span>) : <span class="apiret">x, y, waypointDescription</span>
...
: [[API C_SuperTrack.GetSuperTrackedItemName|C_SuperTrack.GetSuperTrackedItemName]]() : <span class="apiret">name, description</span>
...
: [[API C_Texture.GetAtlasElements|C_Texture.GetAtlasElements]]() : <span class="apiret">atlases</span>
...
: [[API GetTotemInfo|GetTotemInfo]](<span class="apiarg">slot</span>) : <span class="apiret">haveTotem, totemName, startTime, duration, icon, modRate, spellID</span> - Returns info for the specified totem.
...
==TradeInfo==
: [[API C_TradeInfo.AddTradeMoney|C_TradeInfo.AddTradeMoney]]() - Adds any cursor-held money to the current trade offer.
: [[API C_TradeInfo.SetTradeMoney|C_TradeInfo.SetTradeMoney]](<span class="apiarg">amount</span>) - Sets the amount of money in the current trade offer.
...
: [[API C_TradeSkillUI.CancelProfessionRespec|C_TradeSkillUI.CancelProfessionRespec]]()
...
: [[API C_TradeSkillUI.CheckRespecNPC|C_TradeSkillUI.CheckRespecNPC]]() : <span class="apiret">canInteract</span>
...
: [[API C_TradeSkillUI.ConfirmProfessionRespec|C_TradeSkillUI.ConfirmProfessionRespec]]()
...
: [[API C_TradeSkillUI.SetOnlyShowSkillUpRecipes|C_TradeSkillUI.SetOnlyShowSkillUpRecipes]](<span class="apiarg">flag</span>)
...
: [[API C_Transmog.IsTransmogEnabled|C_Transmog.IsTransmogEnabled]]() : <span class="apiret">isTransmogEnabled</span>
...
The wardrobe, also known as the [[Appearances]] tab was added in [[Patch 7.0.3]]
...
: [[API C_TransmogCollection.GetCategoryInfo|C_TransmogCollection.GetCategoryInfo]](<span class="apiarg">category</span>) : <span class="apiret">name, isWeapon, canHaveIllusions, canMainHand, canOffHand, canRanged</span>
...
: [[API C_TransmogSets.GetValidClassForSet|C_TransmogSets.GetValidClassForSet]](<span class="apiarg">transmogSetID</span>) : <span class="apiret">classID</span>
...
==UIMacros==
: [[API C_Macro.GetMacroName|C_Macro.GetMacroName]](<span class="apiarg">macroId</span>) : <span class="apiret">name</span>
: [[API C_Macro.GetSelectedMacroIcon|C_Macro.GetSelectedMacroIcon]](<span class="apiarg">macroId</span>) : <span class="apiret">textureNum</span>
...
==UIWidgetManager==
The UI widget system was added in [[Patch_8.0.1/API_changes|Patch 8.0.1]] to replace the WorldStateFrame.
...
: [[API C_UIWidgetManager.GetButtonHeaderWidgetVisualizationInfo|C_UIWidgetManager.GetButtonHeaderWidgetVisualizationInfo]](<span class="apiarg">widgetID</span>) : <span class="apiret">widgetInfo</span>
...
: [[API UnitCreatureFamily|UnitCreatureFamily]](<span class="apiarg">unit</span>) : <span class="apiret">name, id</span> - Returns the creature type of the unit (e.g. Crab).
: [[API UnitCreatureType|UnitCreatureType]](<span class="apiarg">unit</span>) : <span class="apiret">name, id</span> - Returns the creature classification type of the unit (e.g. Beast).
...
: [[API UnitExists|UnitExists]](<span class="apiarg">[unit]</span>) : <span class="apiret">result</span> - Returns true if the unit exists and can be targeted.
...
: [[API UnitInOtherParty|UnitInOtherParty]](<span class="apiarg">unit</span>) : <span class="apiret">inOtherParty</span>
...
: [[API UnitIsVisible|UnitIsVisible]](<span class="apiarg">[unit]</span>) : <span class="apiret">result</span> - Returns true if the unit is visible to the game client.
: [[API UnitIsWildBattlePet|UnitIsWildBattlePet]](<span class="apiarg">unit</span>) : <span class="apiret">result</span>
: [[API UnitLeadsAnyGroup|UnitLeadsAnyGroup]](<span class="apiarg">unit</span>) : <span class="apiret">isLeader</span>
...
: [[API UnitOwnerGUID|UnitOwnerGUID]](<span class="apiarg">unit</span>) : <span class="apiret">ownerGUID</span>
...
==UnitRole==
: [[API AreClassRolesSoftSuggestions|AreClassRolesSoftSuggestions]]() : <span class="apiret">result</span>
...
: [[API UnitGetAvailableRoles|UnitGetAvailableRoles]](<span class="apiarg">unit</span>) : <span class="apiret">tank, healer, dps</span>
...
: [[API C_VignetteInfo.GetHealthPercent|C_VignetteInfo.GetHealthPercent]](<span class="apiarg">vignetteGUID</span>) : <span class="apiret">healthPct</span>
: [[API C_VignetteInfo.GetRecommendedGroupSize|C_VignetteInfo.GetRecommendedGroupSize]](<span class="apiarg">vignetteGUID</span>) : <span class="apiret">minGroupSize, maxGroupSize</span>
...
==WarbandSceneInfo==
: [[API C_WarbandScene.GetRandomEntryID|C_WarbandScene.GetRandomEntryID]]() : <span class="apiret">warbandSceneID</span>
: [[API C_WarbandScene.GetWarbandSceneEntry|C_WarbandScene.GetWarbandSceneEntry]](<span class="apiarg">warbandSceneID</span>) : <span class="apiret">warbandSceneEntry</span>
: [[API C_WarbandScene.HasWarbandScene|C_WarbandScene.HasWarbandScene]](<span class="apiarg">warbandSceneID</span>) : <span class="apiret">owned</span>
: [[API C_WarbandScene.IsFavorite|C_WarbandScene.IsFavorite]](<span class="apiarg">warbandSceneID</span>) : <span class="apiret">favorite</span>
: [[API C_WarbandScene.SearchWarbandSceneEntries|C_WarbandScene.SearchWarbandSceneEntries]](<span class="apiarg">searchParams</span>) : <span class="apiret">matchingEntryIDs</span>
: [[API C_WarbandScene.SetFavorite|C_WarbandScene.SetFavorite]](<span class="apiarg">warbandSceneID, favorite</span>)
...
==WorldLootObject==
: [[API C_WorldLootObject.DoesSlotMatchInventoryType|C_WorldLootObject.DoesSlotMatchInventoryType]](<span class="apiarg">slot, inventoryType</span>) : <span class="apiret">matches</span>
: [[API C_WorldLootObject.GetWorldLootObjectDistanceSquared|C_WorldLootObject.GetWorldLootObjectDistanceSquared]](<span class="apiarg">unitToken</span>) : <span class="apiret">distanceSquared</span>
...
: [[API C_WorldLootObject.GetWorldLootObjectInfoByGUID|C_WorldLootObject.GetWorldLootObjectInfoByGUID]](<span class="apiarg">objectGUID</span>) : <span class="apiret">info</span>
...
: [[API C_WorldLootObject.IsWorldLootObjectByGUID|C_WorldLootObject.IsWorldLootObjectByGUID]](<span class="apiarg">guid</span>) : <span class="apiret">isWorldLootObject</span>
...
: [[API C_WorldLootObject.OnWorldLootObjectClick|C_WorldLootObject.OnWorldLootObjectClick]](<span class="apiarg">unitToken, isLeftClick</span>)
...
=Namespaces=
These functions are mostly undocumented and do not have an API system name.
...
: [[API C_Debug.ToggleDebugCharInfo|C_Debug.ToggleDebugCharInfo]]()
...
: [[API C_SpectatingUI.StartSpectating|C_SpectatingUI.StartSpectating]]()
...
==C_Widget==
: [[API C_Widget.IsFrameWidget|C_Widget.IsFrameWidget]](<span class="apiarg">object</span>)
: [[API C_Widget.IsRenderableWidget|C_Widget.IsRenderableWidget]](<span class="apiarg">object</span>)
: [[API C_Widget.IsWidget|C_Widget.IsWidget]](<span class="apiarg">object</span>)

==C_WowLabsDataManager==
: [[API C_WowLabsDataManager.GetConfirmedWoWLabsArea|C_WowLabsDataManager.GetConfirmedWoWLabsArea]]()
: [[API C_WowLabsDataManager.GetWoWLabsAreaInfo|C_WowLabsDataManager.GetWoWLabsAreaInfo]]()
: [[API C_WowLabsDataManager.IsInPrematch|C_WowLabsDataManager.IsInPrematch]]()
: [[API C_WowLabsDataManager.PushCircleInfoToLua|C_WowLabsDataManager.PushCircleInfoToLua]]()
: [[API C_WowLabsDataManager.QuerySelectedWoWLabsArea|C_WowLabsDataManager.QuerySelectedWoWLabsArea]]()
: [[API C_WowLabsDataManager.QueryWoWLabsAreaInfo|C_WowLabsDataManager.QueryWoWLabsAreaInfo]]()
: [[API C_WowLabsDataManager.SelectWoWLabsArea|C_WowLabsDataManager.SelectWoWLabsArea]]()
...
: [[API C_WoWLabsMatchmaking.ClearFastLogin|C_WoWLabsMatchmaking.ClearFastLogin]]()
: [[API C_WoWLabsMatchmaking.DeclinePartyInvite|C_WoWLabsMatchmaking.DeclinePartyInvite]]()
: [[API C_WoWLabsMatchmaking.GetAutoQueueOnLogout|C_WoWLabsMatchmaking.GetAutoQueueOnLogout]]()
...
: [[API C_WoWLabsMatchmaking.IsFastLogin|C_WoWLabsMatchmaking.IsFastLogin]]()
...
: [[API C_WoWLabsMatchmaking.SetAutoQueueOnLogout|C_WoWLabsMatchmaking.SetAutoQueueOnLogout]]()
...
=Categories=
These functions are not part of an API system.
...
==Companions==
Relates to the old companion API (non-combat pets and mounts)
...
[[Target_marker|Raid Target]]s and [[World Marker]]s
...
: [[API RemoveRaidTargets|RemoveRaidTargets]]()
...
: [[API SetSendMailShowing|SetSendMailShowing]](<span class="apiarg">shown</span>)
...
==Petitions==
Petitions are signup documents for guilds and arena teams.
...
: [[API issecurevalue|issecurevalue]](<span class="apiarg">value</span>) : <span class="apiret">isSecure, taint</span>
...
: [[API setsecurehookforbidden|setsecurehookforbidden]]()
...
===Environment===
These were moved C-side from [https://github.com/Gethe/wow-ui-source/blob/11.1.0/Interface/AddOns/Blizzard_SharedXML/EnvironmentUtil.lua EnvironmentUtil.lua] in 11.1.5
: [[API GetCurrentEnvironment|GetCurrentEnvironment]]()
: [[API GetGlobalEnvironment|GetGlobalEnvironment]]()
: [[API IsInGlobalEnvironment|IsInGlobalEnvironment]]()
: [[API SwapToGlobalEnvironment|SwapToGlobalEnvironment]]()
...
: [[API securecall|securecall]](<span class="apiarg">funcOrKey, ...</span>) : <span class="apiret">...</span> - Calls the specified function without propagating taint to the caller.
