# API C EquipmentSet.GetItemLocations
...
==Returns==
:;locations:{{apitype|number[]}} - indexed by [[InventorySlotId]]
...
* Any other value can be examined by calling {{api|EquipmentManager_UnpackLocation}}
