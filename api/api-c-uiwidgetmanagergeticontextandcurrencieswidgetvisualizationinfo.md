# API C UIWidgetManager.GetIconTextAndCurrenciesWidgetVisualizationInfo
...
==Returns==
:;widgetInfo:{{apitype|IconTextAndCurrenciesWidgetVisualizationInfo?}}
...
|-
| descriptionShownState || {{apitype|Enum.WidgetShownState}} || 
|-
| descriptionEnabledState || {{apitype|Enum.WidgetEnabledState}} || 
|-
| text || {{apitype|string}} || 
|-
