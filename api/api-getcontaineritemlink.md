...
==Arguments==
:;bagID:{{apitype|number}} - Bag index ([[bagID]]). Valid indices are integers -2 through 11. 0 is the backpack.
:;slotIndex:{{apitype|number}} - Slot index within the specified bag, ascending from 1. Slot 1 is typically the leftmost topmost slot.

==Returns==
:;itemLink:{{apitype|string}} - a chat link for the object in the specified bag slot; nil if there is no such object. This is typically, but '''not always''' an [[ItemLink]].
