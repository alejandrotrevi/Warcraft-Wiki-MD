# API C QuestLog.GetQuestTagInfo
...
==Returns==
:;info:{{apitype|QuestTagInfo?}}
{| class="sortable darktable zebra" style="margin-left: 3.9em"
! Field !! Type !! Description
|-
| tagName || {{apitype|string}} || 
|-
| tagID || {{apitype|number}} || {{dbc|questinfo|QuestInfo}}
|-
| worldQuestType || {{apitype|number?}} || [https://github.com/Ketho/BlizzardInterfaceResources/blob/9.0.1/Resources/LuaEnum.lua#L1754 Enum.QuestTagType]
|-
| quality || {{apitype|Enum.WorldQuestQuality?}} || 
|-
| tradeskillLineID || {{apitype|number?}} || [[TradeSkillLineID]]
|-
| isElite || {{apitype|boolean?}} || 
|-
| displayExpiration || {{apitype|boolean?}} || 
|}
...
==Patch changes==
* {{Patch 9.0.1|note=Moved to <code>C_QuestLog.GetQuestTagInfo()</code> and returns structured data.}}
* {{Patch 6.0.2|note=Added as {{api|GetQuestTagInfo}}()}}
```