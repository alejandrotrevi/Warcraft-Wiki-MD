# API C UIWidgetManager.GetFillUpFramesWidgetVisualizationInfo
...
==Returns==
:;widgetInfo:{{apitype|FillUpFramesWidgetVisualizationInfo?}}
{| class="sortable darktable zebra" style="margin-left: 3.9em"
! Field !! Type !! Description
|-
| shownState || {{apitype|Enum.WidgetShownState}} || 
|-
| fillMin || {{apitype|number}} || 
|-
| fillMax || {{apitype|number}} || 
|-
| fillValue || {{apitype|number}} || 
|-
| numTotalFrames || {{apitype|number}} || 
|-
| numFullFrames || {{apitype|number}} || 
|-
| pulseFillingFrame || {{apitype|boolean}} || 
|-
