...
==Returns==
:;link:{{apitype|string}} - An [[EnchantLink]] (color coded with href) which can be included in chat messages to show the reagents and the items the craft creates.
