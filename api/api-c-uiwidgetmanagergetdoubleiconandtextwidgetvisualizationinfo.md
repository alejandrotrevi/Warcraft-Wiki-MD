# API C UIWidgetManager.GetDoubleIconAndTextWidgetVisualizationInfo
...
==Returns==
:;widgetInfo:{{apitype|DoubleIconAndTextWidgetVisualizationInfo?}}
{| class="sortable darktable zebra" style="margin-left: 3.9em"
! Field !! Type !! Description
|-
| shownState || {{apitype|Enum.WidgetShownState}} || 
|-
| label || {{apitype|string}} || 
|-
| leftText || {{apitype|string}} || 
|-
| leftTooltip || {{apitype|string}} || 
|-
| rightText || {{apitype|string}} || 
|-
| rightTooltip || {{apitype|string}} || 
|-
