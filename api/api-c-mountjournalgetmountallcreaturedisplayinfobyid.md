# API C MountJournal.GetMountAllCreatureDisplayInfoByID
...
==Arguments==
===<font color="#4ec9b0">GetMountAllCreatureDisplayInfoByID</font>===
:;mountID:{{apitype|number}} : [[MountID]]
===<font color="#4ec9b0">GetDisplayedMountAllCreatureDisplayInfo</font>===
:;displayIndex:{{apitype|number}} - the index of the displayed mount, i.e. mount in list that matches current search query and filters, in the range of 1 to {{api|C_MountJournal.GetNumDisplayedMounts}}

==Returns==
:;allDisplayInfo:structure - MountCreatureDisplayInfo[]
{{:Struct_MountJournal.MountCreatureDisplayInfo}}

==Values==
{{i-note|This list is up to date as of patch 8.1.5 (29737) Mar 14 2019|note}}
