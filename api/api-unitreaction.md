...
:;otherUnit:{{apitype|string}} : [[UnitId]] - The unit to compare with the first unit.

===Returns===
:;reaction:{{apitype|number}} - the level of the reaction of unit towards otherUnit - this is a number between 1 and 8. 
::# [[Hated]]
::# [[Hostile]]
::# [[Unfriendly]]
::# [[Neutral]]
...
* When you're Horde, the reaction of Alliance reputation-faction NPCs to you and your pet is 1<!-- Tested with Silver Covenant NPCs in Dalaran. -->. The same is true of Horde NPCs if you're Alliance.
